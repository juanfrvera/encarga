...
import { PedidoService } from 'src/app/cliente/service/pedido.service';
import { routeData } from '../cliente.routing.module';
...
export class PedidoComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.pipe(
      map(paramMap => paramMap.get(routeData.comercioUrlParameter)),
